    ...
    @section('content')
        <div
            ...
            @foreach($cards as $card)
                <x-FeatureCVCard :image="$card['image']" :code="$card['code']" :status="$card['status']"
                    :location="$card['location']" :birth_year="$card['birth_year']" :profession="$card['profession']"
        ...
        <div id="filterSidebar"
            ...
            <div class="p-4 md:pt-10">
                ...
                <x-filter.section title="প্রাথমিক">
                    ...
                    <x-filter.age-range label="বয়স" min="18" max="60" minValue="18" maxValue="60" />
                </x-filter.section>

                <x-filter.section title="ঠিকানা">

                    <x-filter.select label="স্থায়ী ঠিকানা" id="location1" name="permanent_address">
                    ...
                    <x-filter.select label="বর্তমান ঠিকানা" id="location2" name="present_address">
                        <option value="">ঠিকানা নির্বাচন করুন</option>
                        <option value="dhaka">ঢাকা</option>
                        <option value="gazipur">গাজীপুর</option>
                        <option value="narayanganj">নারায়ণগঞ্জ</option>
