...
<div class="relative w-full overflow-hidden mt-16" id="carousel">
    <!-- Slides -->
    ...
    <!-- Prev/Next -->
    <button id="prev"
      class="absolute left-0 top-1/2 -translate-y-1/2 bg-black bg-opacity-30 text-white p-3 z-10">❮</button>
    <button id="next"
      class="absolute right-0 top-1/2 -translate-y-1/2 bg-black bg-opacity-30 text-white p-3 z-10">❯</button>
